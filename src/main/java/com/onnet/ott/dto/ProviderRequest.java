...
public class ProviderRequest {
	...
	public ProviderRequest(long providerId, String providerName, int provideTier, int concurrentViews, int offeredPrice,
	...
	public String toString() {
		return "ProviderRequest [providerId=" + providerId + ", providerName=" + providerName + ", provideTier="
